...
const projectList: IProject[] = [
  { title: "Vertical", path: "/parallax/vertical" },
  { title: "Horizontal", path: "/parallax/horizontal" },
  { title: "Sticky", path: "/parallax/sticky" },
];

const ParallaxIndex: FC<Props> = () => {
